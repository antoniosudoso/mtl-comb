...
from util import get_data, standardize_series, get_data_LargeST
...
if __name__ == '__main__':
    ...
    f_model.save('./saved_model_M4/' + SERIES_TYPE + '/main/f_model_' + str(LAMBDA))
    w_model.save('./saved_model_M4/' + SERIES_TYPE + '/main/w_model_' + str(LAMBDA))
